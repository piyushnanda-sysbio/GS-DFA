...
ihsarscov2.metFormulas(ismember(ihsarscov2.mets,met))={'X'}
ihsarscov2.metFrom(ismember(ihsarscov2.mets,met))={'SARS'}
...
met='sarscov2x'
ihsarscov2=addMetabolite(ihsarscov2,met)
ihsarscov2.metComps(ismember(ihsarscov2.mets,met))=9 %Add to extracellular space
ihsarscov2.metNames(ismember(ihsarscov2.mets,met))={'VBOF'}
ihsarscov2.metFormulas(ismember(ihsarscov2.mets,met))={'X'}
ihsarscov2.metFrom(ismember(ihsarscov2.mets,met))={'HMRdatabase'}

%Add transport reaction from extracellular to boundary

ihsarscov2=addReaction(ihsarscov2,'VBOFEx','reactionFormula','sarscov2s <=> sarscov2x')
